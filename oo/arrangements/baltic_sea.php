...
var extent = new OpenLayers.Bounds(-180,-90,180,90);
     ...
     var helsinki=new OpenLayers.Layer.WMS(
       ...
       {singleTile:true, visibility:true, opacity:1, layerId:'HELCON', displayInLayerSwitcher:false}
     );
...
-->
     ...
     var ibsfc = new OpenLayers.Layer.WMS(
       ...
       {tiled:false, visibility:true, opacity:1, layerId:'IBSFC', displayInLayerSwitcher:false}
       );
