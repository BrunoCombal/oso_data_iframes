    ...
    <script>
     jQuery(document).ready(function(){
       ...
       var worldtop=new OpenLayers.Layer.WMS(
         "Countries",
         GWC, //"http://onesharedocean.org/geoserver/general/wms",
	 ...
	 GWC,
       ...
       var eez = new OpenLayers.Layer.WMS(
         ...
         //"http://onesharedocean.org/geoserver/ocean/wms",
         GWC,
         {layers:"general:outer_line_EEZ", transparent:true, styles:'eez_nofill_contour_orange_labels'},
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG, isBaseLayer:false, opacity:1, visibility:false, wrapDateLine:true,
       ...
       var ices=new OpenLayers.Layer.WMS(
         ...
         {tiled:true,  tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'ICES', displayInLayerSwitcher:false, wrapDateLine:true}
       );
       ...
       var nammco=new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'NAMMCO', displayInLayerSwitcher:false, wrapDateLine:true}
       );
       ...
       var neafc=new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'NEAFC', displayInLayerSwitcher:false, wrapDateLine:true}
       );
       ...
       var nasco=new OpenLayers.Layer.WMS(
         ...
         {tiled:true,  tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'NASCO', displayInLayerSwitcher:false, wrapDateLine:true}
       );
       ...
       var helsinki=new OpenLayers.Layer.WMS(
         ...
         {tiled:true,  tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'HELCON', displayInLayerSwitcher:false, wrapDateLine:true}
       );
       ...
       */
       ...
       var ibsfc = new OpenLayers.Layer.WMS(
         ...
         {tiled:true,  tileSize:TSIZE, tileOrigin:TORG, visibility:true, opacity:1, layerId:'IBSFC', displayInLayerSwitcher:false, wrapDateLine:true}
       );
