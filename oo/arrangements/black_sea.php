...
//////////////////////////////////////////////////////////////
     ...
     var bucharest=new OpenLayers.Layer.WMS(
       ...
       {singleTile:true, visibility:true, opacity:1, layerId:'Bucharest', displayInLayerSwitcher:false}
     );
     ...
     var gfcm=new OpenLayers.Layer.WMS(
       ...
       {singleTile:true, visibility:true, opacity:1, layerId:'GFCM', displayInLayerSwitcher:false}
     );
     ...
     var eu = new OpenLayers.Layer.WMS(
       ...
       {tiled:true, visibility:true, opacity:1, layerId:'EU', displayInLayerSwitcher:false}
     );
