    ...
    <script>
	 ...
	 GWC,
       ...
       var npafc=new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG,visibility:true, opacity:1, wrapDateLine:true, layerId:'NPAFC', displayInLayerSwitcher:false}
       );
       ...
       var pices=new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG,vvisibility:true, opacity:1, wrapDateLine:true, layerId:'PICES', displayInLayerSwitcher:false}
       );
       ...
       var wcpfc=new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG,visibility:true, opacity:1, wrapDateLine:true, layerId:'WCPFC', displayInLayerSwitcher:false}
       );
       ...
       var nowpap = new OpenLayers.Layer.WMS(
         ...
         {tiled:true, tileSize:TSIZE, tileOrigin:TORG,visibility:true, opacity:1, layerId:'NOWPAP', displayInLayerSwitcher:false}
       );
