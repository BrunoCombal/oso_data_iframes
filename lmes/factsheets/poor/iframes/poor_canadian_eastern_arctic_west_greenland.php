  ...
  <head>
    ...
    <script type="text/javascript">
     $(document).ready(function() {
       ...
       <?php } else { ?>
       var title = "Coastal Poor (Canadian Eastern Arctic West Greenland)";
       <?php } ?>
	 ...
	 if (value == "NaN") {return "No data"} else {return(numberWithCommas(value));};
             ...
             if (line) { // ignore empty line (else lines are not drawn)
               ...
               <?php } ?>
                 var lme = {
                   ...
                   lmeName: items[1],
                   poor: parseFloat(items[2]).toFixed(0)
                 };
       ...
       $(function() {
         ...
         $('#printPlot').click(function(){
           var text = '/iframes/lmes/factsheets/poor/iframes/printAll.php';
