...
<html>
    ...
    function init(){    
		...
		var countries = new OpenLayers.Layer.WMS(
			...
			{layers:'general:Countries_north_epsg_3995', isBaseLayer:true, styles:'countries_north_gray', projection:'EPSG:3995', units:'m'},
			{singletile:true}
		)
		*/
		...
		var lmes=new OpenLayers.Layer.WMS(
			"LMEs", 'http://onesharedocean.org/geoserver/general/wms',
			{layers:'general:LMEs_north_epsg_3995', transparent:true, styles:'lmes_colors_north', projection:'EPSG:3995', units:'m'},
			{singleTile:true, isBaseLayer:false, opacity:1, visibility:true, projection:'EPSG:3995', units:'m'}
			);
		*/
		
		var lmes=new OpenLayers.Layer.WMS(
			"LMEs", 'http://onesharedocean.org/geoserver/general/wms',
			{layers:'general:LMEs_north_epsg_3995', transparent:true, styles:'lmes_grey_noname'},
