...
<html>
  <head>
    ...
    <title>LMEs Climate Threat</title>
    ...
    <script type="text/javascript">
     $(document).ready(function() {
       ...
       var outdata = "/iframes/lmes/factsheets/climateThreat/data"+'/data.csv';
       var lmesData = [];
       <?php if($zero){ ?>
       var title = "Climate Threat";
       <?php } else { ?>
       var title = "Climate Threat (Canadian Eastern Arctic West Greenland)";
       <?php } ?>
       ...
       $('#viewData').click(function(){
         var sourceURL = "http://onesharedocean.org/data#456";
         if(sameHost){
             ...
             if (line) { // ignore empty line (else lines are not drawn)
               ...
               <?php } ?>
                 var lme = {
                   ...
                   lmeName: items[1],
                   threatIndex: parseFloat(items[2]).toFixed(4),
                 ...
                 $(td2).html( numberWithCommasNoData( lme.threatIndex) );
       ...
       $(function() {
         ...
         $('#printPlot').click(function(){
           var text = '/iframes/lmes/factsheets/climateThreat/iframes/printAll.php';
