...
inFile="/data/public_store/lmes_socioeco/rsrc/wrk_files/lmes_climate_threat_extract.csv"
template='climate_threat_template.html'

outDir="/data/iframes/lmes/factsheets/climateThreat"
...
do
    ...
    iframe=${iframeDir}/climate_threat_${namePhp}.php
