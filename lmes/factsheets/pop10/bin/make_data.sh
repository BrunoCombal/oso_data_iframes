...
template='pop10_template.html'
temp=''
out="/data/iframes/lmes/factsheets/pop10"
...
do
	...
	iframe=${outiframe}/pop10_${name}.php
...
echo "Population Below 10m ... DONE!"
