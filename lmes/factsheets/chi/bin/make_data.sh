...
inDir='/data/public_store/lmes_chi'
inFile='lme_cumulative_impacts_2013.csv'
template='chi_template.html'
temp=''
out='/data/iframes/lmes/factsheets/chi'
outddata='data'$temp
...
lme=${lme:2}
	...
	iframe=${outiframe}/chi_${name}.php
