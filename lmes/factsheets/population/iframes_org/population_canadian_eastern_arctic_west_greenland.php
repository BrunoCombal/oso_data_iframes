  ...
  <head>
    ...
    <script type="text/javascript">
     $(document).ready(function() {
       ...
       <?php } else { ?>
       var title = "Population (Canadian Eastern Arctic West Greenland)";
       <?php } ?>
	 ...
	 if (value == "NaN") {return "No data"} else {return(numberWithCommas(value));};
             ...
             if (line) { // ignore empty line (else lines are not drawn)
               ...
               <?php } ?>
                 var lme = {
                   ...
                   lmeName: items[1],
                   areaRural: parseFloat(items[2]).toFixed(0),
                   areaUrban: parseFloat(items[3]).toFixed(0),
                   areaTotal: parseFloat(items[4]).toFixed(0),
                   pop2010Rural: parseFloat(items[5]).toFixed(0),
                   pop2010Urban: parseFloat(items[6]).toFixed(0),
                   pop2010Total: parseFloat(items[7]).toFixed(0),
                   pop201010m10km: parseFloat(items[8]).toFixed(0),
                   pop2100Rural: parseFloat(items[9]).toFixed(0),
                   pop2100Urban: parseFloat(items[10]).toFixed(0),
                   pop2100Total: parseFloat(items[11]).toFixed(0),
                   pop210010m10kmSPP1: parseFloat(items[12]).toFixed(0),
                   pop210010m10kmSPP3: parseFloat(items[13]).toFixed(0),
                 };
                 ...
                 $(td2).html( numberWithCommasNoData( lme.pop2010Total) );
                 var td3 = document.createElement('TD');
                 $(td3).html( numberWithCommasNoData( lme.pop2100Total) );
                 var td4 = document.createElement('TD');
                 $(td4).html( numberWithCommasNoData(lme.pop2010Rural) );
                 var td5 = document.createElement('TD');
                 $(td5).html( numberWithCommasNoData( lme.pop2100Rural ));
		 //assign color classes
                 $(td2).addClass(popClass(lme.pop2010Total));
                 $(td3).addClass(popClass(lme.pop2100Total));
                 $(td4).addClass(popClass(lme.pop2010Total));
                 $(td5).addClass(popClass(lme.pop2100Total));
       ...
       $(function() {
         ...
         $('#printPlot').click(function(){
           var text = '/iframes/lmes/factsheets/population/iframes/printAll.php';
