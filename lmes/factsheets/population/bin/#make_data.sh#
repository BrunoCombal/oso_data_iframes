...
inFile="/data/public_store/lmes_socioeco/rsrc/wrk_files/lmes_population_extract.csv"
template='population_template.html'

outDir="/data/iframes/lmes/factsheets/population"
...
do
    ...
    iframe=${iframeDir}/population_${namePhp}.php
