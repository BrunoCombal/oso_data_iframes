...
<html>
  <head>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
		...
		var plotCounter = -1;
		var outdata = '../'+"data"+'/';
		var title = "Catch from bottom impacting gear";
  ...
  if(plotCounter == 0) {
	...
	var catchbtm_series={name:'Catch Btm gear', data:[], lineWidth:1.5, color: lineColors[plotCounter], zIndex:plotCounter, marker:{lineColor: '#ffffff', lineWidth:1.5, fillColor: lineColors[plotCounter], symbol:'circle'}};
	
  } else {
  
  
	var catchbtm_series={name:'Catch Btm gear ('+LMECode+')', data:[], lineWidth:1.5, color: lineColors[plotCounter], zIndex:plotCounter, marker:{lineColor: '#ffffff', lineWidth:1.5, fillColor: lineColors[plotCounter], symbol:'circle'}};
  }
