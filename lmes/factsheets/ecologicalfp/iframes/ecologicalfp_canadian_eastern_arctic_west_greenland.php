  ...
  <head>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
		...
		var plotCounter = -1;
		var outdata = '../'+"data"+'/';
		var title = "Ecological footprint";
		var legend = "";
		var iFr = false;
...
<?php } ?>
  ...
  if(plotCounter == 0) {
	...
	var catchbtm_series={name:'Ecological footprint', data:[], lineWidth:1.5, color: lineColors[plotCounter], zIndex:plotCounter, marker:{lineColor: '#ffffff', lineWidth:1.5, fillColor: lineColors[plotCounter], symbol:'circle'}};
	
  } else {
  
  
	var catchbtm_series={name:'Ecological footprint ('+LMECode+')', data:[], lineWidth:1.5, color: lineColors[plotCounter], zIndex:plotCounter, marker:{lineColor: '#ffffff', lineWidth:1.5, fillColor: lineColors[plotCounter], symbol:'circle'}};
  }
