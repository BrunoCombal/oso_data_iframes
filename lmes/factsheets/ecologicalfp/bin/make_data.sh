...
inFile='LME_ecological_Footprint.csv'
template='ecologicalfp_template.html'
temp=''
out='/data/iframes/lmes/factsheets/ecologicalfp/'
outddata='data'$temp
...
echo "Fisheries -> Ecological Footprint"
...
do
    if [[ $f != *LME* ]]; then
        ...
        iframe=${outiframe}/ecologicalfp_${name}.php
